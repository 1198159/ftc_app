                    ...
                    switch (assist)
                    {
                        case ASSISTING:
                        {
                            switch (position)
                            {
                                case LEFT:
                                {
                                    moveAuto(0, -320, 0.5, 0.3, 3.0);
                                    moveAuto(400, 0, 0.7, 0.3, 3.0);
                                    moveAuto(0, -680, 0.7, 0.3, 3.0);
                                    moveAuto(0, 80, 0.7, 0.3, 3.0);
                                    fastFlex();
                                    imuPivot(referenceAngle, -90, 1.0, 0.015, 3.0);
                                    moveAuto(0, -150, 0.7, 0.3, 3.0);
                                    moveAuto(150, 0, 0.7, 0.3, 3.0);
                                    moveAuto(0, -330, 0.7, 0.3, 3.0);
                                    dropJJ();
                                    sleep(500);
                                    fastFlex();
                                    moveAuto(0, -280, 0.7, 0.3, 3.0);
                                    reverseImuPivot(referenceAngle, 45, 0.3, 0.015, 2.0);
                                    moveAuto(0, -380, 0.7, 0.3, 3.0);
                                    moveAuto(200, 0, 0.4, 0.3, 3.0);
                                    moveAuto(0, -380, 0.7, 0.3, 3.0);
                                    moveAuto(-150, 0, 0.7, 0.3, 3.0);
                                    reverseImuPivot(referenceAngle, 0, 0.3, 0.015, 2.0);
                                    moveAuto(0, -735, 0.7, 0.3, 3.0);
                                    reverseImuPivot(referenceAngle, 90, 0.3, 0.015, 2.0);
                                    moveAuto(0, -100, 0.7, 0.3, 3.0);
                                    break;
                                }
                                case CENTER:
                                {
                                    moveAuto(0, -1200, 0.5, 0.35, 3.0);
                                    moveAuto(0, 80, 0.7, 0.3, 3.0);
                                    fastFlex();
                                    imuPivot(referenceAngle, -90, 1.0, 0.015, 3.0);
                                    moveAuto(0, -80, 0.7, 0.3, 3.0);
                                ...
                                {
                                    moveAuto(0, -320, 0.5, 0.3, 3.0);
                                    moveAuto(-480, 0, 0.7, 0.3, 3.0);
                                    moveAuto(0, -830, 0.7, 0.5, 3.0);
                                    moveAuto(0, 130, 0.7, 0.3, 3.0);
                                    fastFlex();
                                    imuPivot(referenceAngle, -90, 1.0, 0.015, 3.0);
                                    moveAuto(0, 10, 0.7, 0.3, 3.0);
                                    moveAuto(150, 0, 0.7, 0.3, 3.0);
                                    moveAuto(0, 140, 0.7, 0.3, 3.0);
                                    dropJJ();
                                    sleep(500);
                                    fastFlex();
                                    break;
