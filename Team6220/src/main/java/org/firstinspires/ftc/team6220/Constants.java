...
public class Constants
{
    ...
    public static final double MINIMUM_ANGLE_DIFF = 3.0;
    public static final double X_TOLERANCE = .010;
    public static final double Y_TOLERANCE = .010;
    public static final double W_TOLERANCE = 3.0;
