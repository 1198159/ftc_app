...
/*
    Class that allows for the implementation of the Vuforia.
    Most of this code is modified and comes from the Vuforia Sample app.
    Credit to FTC Team 3491 FIX IT for implementation.
*/

public class VuforiaTracker implements Vuforia.UpdateCallbackInterface {
     ...
     */
    public VuforiaTracker(Activity activity) {
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            synchronized (shutdownLock) {
                Vuforia.setInitParameters(activity, VuforiaBase.GL_20, "");
    ...
    private class LoadTrackerTask extends AsyncTask<Void, Integer, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (!result) {
                ...
                Vuforia.registerCallback(VuforiaTracker.this);
